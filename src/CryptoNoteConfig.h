...
const uint64_t MAX_TX_MIXIN_SIZE                             = 9;
...
static constexpr uint64_t POISSON_CHECK_DEPTH = 40;   // Main-chain depth of the poisson check. The attacker will have to tamper 50% of those blocks
